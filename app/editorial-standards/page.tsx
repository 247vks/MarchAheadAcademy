...
const sourceOrder = [
  ...
  'Current notice on the relevant official recruitment portal',
  'Stable UPSC or service information page',
  'Ministry of Defence or PIB material for policy context',
  'Secondary context only when no decision-critical fact depends on it',
];
      ...
      <section className="command-blue text-white">
        <div className="mx-auto max-w-6xl px-5 py-16 lg:px-8 lg:py-20">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
            Our rules for sourcing, freshness, uncertainty, independence and
            corrections are public so readers can judge the quality of our work.
          </p>
        </div>
      </section>
      <section className="mx-auto max-w-6xl px-5 py-16 lg:px-8 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-[1fr_320px]">
          <article className="space-y-12">
            <section>
              <p className="section-kicker">Source hierarchy</p>
              <h2 className="mt-3 font-heading text-3xl">
                What controls our answer
              </h2>
              <ol className="mt-6 grid gap-3">
                {sourceOrder.map((item, index) => (
                  <li
                    key={item}
                    className="flex gap-4 border border-[#cbd3ce] bg-white p-4"
                  >
                    <span className="font-heading text-[#397fa8]">
                      0{index + 1}
                    </span>
              ...
              <p className="mt-4 text-sm leading-6 text-[#5c6974]">
                Search snippets, coaching websites and AI-generated answers are
                not evidence.
              </p>
            </section>
            <section>
              <p className="section-kicker">Review and labelling</p>
              <h2 className="mt-3 font-heading text-3xl">
            ...
            <section>
              ...
              <div className="mt-5 flex gap-3 border-l-4 border-[#e88620] bg-white p-5">
                ...
                <p className="text-sm leading-6">
                  <strong>Report a correction:</strong> email{' '}
                  <a
                  ...
                  with the page address, disputed information and the official
            ...
            <section>
              ...
              <ul className="mt-5 grid gap-3 text-sm">
                {[
                  'Guaranteed selection, medical clearance or a “sure-shot” method',
                  'Government affiliation, endorsement or privileged selection access',
                  'Predicted cut-offs presented as official facts',
                  'Success rates, testimonials or credentials without supporting evidence and permission',
                ].map((item) => (
                  <li key={item} className="flex gap-3 bg-white p-4">
          ...
          <aside>
            <div className="sticky top-6 border-t-4 border-[#397fa8] bg-white p-6">
              ...
              <p className="text-xs leading-5 text-[#697781]">
                ...
                <br />
                Next policy review: 6 December 2026
              </p>
            </div>
          </aside>
        </div>
