...
export default function Page() {
  return (
    <AuthorityPage
      ...
      expertContext="Commander Sharma’s experience teaching Army, Navy and Air Force cadets at the National Defence Academy informs the academy’s emphasis on academic foundations, informed service choice and preparation beyond the written examination."
      sections={[
