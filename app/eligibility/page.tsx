...
export default function Page() {
  return (
    <AuthorityPage
      ...
      expertContext="Commander Sharma’s recruitment and candidate-guidance experience informs the questions this page asks. Current official notices—not academy judgement—control a candidate’s eligibility and medical assessment."
      sections={[
        {
